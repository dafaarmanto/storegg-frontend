import { TransactionDetailsContentProps } from "../../../services/data-types";
import Sidebar from "../Sidebar";
import Row from "./Row";
import NumericSpecial from './NumericSpecial';

export default function TransactionDetailContent(props: TransactionDetailsContentProps) {
	const { data } = props;
									...
									<div className="main-content main-content-card overflow-auto">
											<section className="checkout mx-auto">
													...
													<div className="purchase pt-30">
															...
															<NumericSpecial label="Price" value={data.historyVoucherTopup.price} />
															<NumericSpecial label="Tax (10%)" value={data.tax} />
															<NumericSpecial label="Total" value={data.value} className="color-palette-4" />
													</div>
