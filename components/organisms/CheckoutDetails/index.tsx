...
export default function CheckoutDetails() {
	...
	const priceTax = dataTopup.nominalItem.price * 10 / 100
	const totalPrice = itemPrice + priceTax
  ...
  return (
    <>
      <div className="purchase pt-md-50 pt-30">
          ...
          <p className="text-lg color-palette-1 mb-20">Order ID <span className="purchase-details">#GG{Math.floor(Math.random() * 101)}</span></p>
          ...
          <p className="text-lg color-palette-1 mb-20">
						...
						<span className="purchase-details">
							<NumericFormat value={itemPrice} prefix="Rp" displayType="text" thousandSeparator="." decimalSeparator="," />
						</span>
					</p>
          <p className="text-lg color-palette-1 mb-20">
						Tax (10%) 
						<span className="purchase-details">
							<NumericFormat value={priceTax} prefix="Rp" displayType="text" thousandSeparator="." decimalSeparator="," />
						</span>
          </p>
          <p className="text-lg color-palette-1 mb-20">
						Total 
						<span className="purchase-details color-palette-4">
							<NumericFormat value={totalPrice} prefix="Rp" displayType="text" thousandSeparator="." decimalSeparator="," />
						</span>
					</p>
      </div>
